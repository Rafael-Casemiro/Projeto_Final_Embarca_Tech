...
#define NUM_PIXELS 25 // Definição do número de LEDS (no caso MATRIZ 5 x 5)


// Função que converte os valores normalizados (0.0 a 1.0) para escala de 8 bits (0 a 255)
